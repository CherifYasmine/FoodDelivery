...
const FoodRestauItems = ({route, navigation}) => {
  ...
  return (
    <ScrollView vertical={true} style={styles.container}>
      <View style={styles.title}>
        ...
        <TouchableHighlight underlayColor={'transparent'} style={styles.cart}>
      ...
      <View style={styles.items}>
        {food.map(item => {
          return (
            ...
            onPress={() => navigation.navigate('SingleFood')}>
...
export default FoodRestauItems;
