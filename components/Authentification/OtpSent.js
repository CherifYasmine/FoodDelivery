...
const OtpSent = ({navigation}) => {
    return(
      ...
      <TouchableHighlight onPress={() =>navigation.navigate('NewPassword')} style={styles.loginTp}>
        <Text style={styles.loginBtn} >Next</Text>
      </TouchableHighlight>
      <Text style={styles.accSign}>
          <Text style={styles.acc}>Didn't Receive?</Text>
            <Text style={styles.sign} onPress={() =>navigation.navigate('OtpSent')}> Click here!</Text>
